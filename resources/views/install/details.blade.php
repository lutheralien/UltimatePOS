              ...
              <form class="form" id="details_form" method="post" 
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="password" name="ENVATO_PURCHASE_CODE" required class="form-control" placeholder="RANDOM" value="RANDOM" id="envato_purchase_code">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="envato_username">Envato Username:*</label>
                        <input type="text" name="ENVATO_USERNAME" required class="form-control" placeholder="RANDOM" value="RANDOM" id="envato_username">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
